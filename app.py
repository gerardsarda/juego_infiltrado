...
# LISTAS VIP (mantiene tu contenido original)
DATOS_VIP = {
    "😈 MODO CANALLA (+18) [VIP]": [
    ...
    "🎬 PELÍCULAS Y SERIES [VIP]": [
        "Breaking Bad", "Stranger Things", "The Office", "Friends", "Game of Thrones",
        "The Crown", "Black Mirror", "Peaky Blinders", "La Casa de Papel", "Dark",
        "Narcos", "The Witcher", "Bridgerton", "The Mandalorian", "The Boys"
    ],
    "🎮 VIDEOJUEGOS [VIP]": [
        "Fortnite", "Minecraft", "FIFA", "Call of Duty", "League of Legends",
        "Among Us", "GTA V", "The Sims", "Animal Crossing", "Valorant"
    ],
    "🎵 MÚSICA Y ARTISTAS [VIP]": [
        "Rosalía", "Bad Bunny", "Taylor Swift", "The Weeknd", "Billie Eilish",
        "Drake", "Dua Lipa", "Harry Styles", "BTS", "Beyoncé"
    ]
}
